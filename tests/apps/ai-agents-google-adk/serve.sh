...
#     -d "{\"app_name\":\"marketing_campaign_agent\",\"user_id\":\"user1\",\"session_id\":\"$SESSION\",
...
echo "Starting ADK API server for marketing_campaign_agent on http://127.0.0.1:${PORT}"
echo "  Swagger UI : http://127.0.0.1:${PORT}/docs"
echo "  Agent name : marketing_campaign_agent"
echo ""
