...
def _build_nuguard_yaml(
    ...
    lines += [
        ...
        "# Set connection details once here; both commands inherit them automatically.",
        "# Override in the behavior: or redteam: sections below when you need per-command differences.",
        "target:",
        f"  url: {target_url}",
        "",
        ...
        "# ─── Behavior analysis ────────────────────────────────────────────────────────",
        "behavior:",
        "  # target: https://override-url.example.com   # overrides target.url for behavior only",
        "  # auth: ...                                   # overrides target.auth for behavior only",
        "",
        ...
        "# ─── Red-team ─────────────────────────────────────────────────────────────────",
        "redteam:",
        "  # target: https://override-url.example.com   # overrides target.url for redteam only",
        "  # auth: ...                                   # overrides target.auth for redteam only",
        "",
